    ...
    SubShader {
        ...
        Pass {
            ...
            half4 Frag(v2f input) : SV_Target {
                ...
                input.positionOS = (_CrackProgress == 0 || dot(input.normalWS, GetViewForwardDir()) > 0.5) ? input.positionOS : CalcCrackedPos(input.positionOS, input.normalOS, crackLevel);
